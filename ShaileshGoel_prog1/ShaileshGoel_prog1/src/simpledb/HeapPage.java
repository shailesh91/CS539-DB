...
public class HeapPage implements Page {
    ...
    public boolean getSlot(int i) {
    	//IMPLEMENT THIS
    	int headerBit = i % 32; // Bit Position
		int headerByte = i / 32; // Integer Position
		return (this.header[headerByte] & (1 << headerBit)) != 0;		
	}
    ...
    private void setSlot(int i, boolean value) {
		...
		int bitIndex = i % 32;
		if (value == false) {
			this.header[byteIndex] &= ~( (byte) 1 << bitIndex); // change the bit value
		} else {
			this.header[byteIndex] |= ( (byte) 1 << bitIndex);
		}
    }
